...
class LocalExecutor(object):
    ...
    def generateRandomParams(self, n):
        ...
        for i in range(0, n):
            ...
            # tempDescriptor = "./tmp/validateDesc.json"
            # with open(tempDescriptor, 'w') as fhandle:
            #     fhandle.write(json.dumps(descriptor, sort_keys=True))
            try:
                # self._validateDict() discontinued
                boutiques.invocation(self.desc_path, "-i", self.invocation)
